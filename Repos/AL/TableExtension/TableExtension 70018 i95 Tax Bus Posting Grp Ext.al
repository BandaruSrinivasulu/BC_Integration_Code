tableextension 70018 "i95 Tax Bus.Posting Group Ext" extends "VAT Business Posting Group"
{
    fields
    {
    ...
    begin
        ...
        IF i95EntityMapping."Allow TaxBusPosG Oubound Sync" = true then begin
    ...
    begin
        if (not UpdatedFromi95) and (i95MandatoryFieldsExists()) then begin
            ...
            i95EntityMapping.Reset();
            IF i95EntityMapping.FindSet() then;
            IF i95EntityMapping."Allow TaxBusPosG Oubound Sync" = true then
                "i95 Sync Status" := "i95 Sync Status"::"Waiting for Sync";
        end;
    end;
