PageExtension 70007 "i95 Sales Order Ext" extends "Sales Order"
{
    layout
    {
        //For charge logic
    ...
    begin
        if (Rec."Document Type" = Rec."Document Type"::Order) and (Rec."i95 Reference ID" <> '') then
        ...
        /*IF ("Document Type" = "Document Type"::Quote) and ("i95 Reference ID" <> '') then
            if Confirm(StrSubstNo(confirmDeleteTxt, Rec."No."), false) then begin
                i95SkipOnDelete := true;
