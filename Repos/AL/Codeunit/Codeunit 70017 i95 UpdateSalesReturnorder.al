codeunit 70017 "I95 Update SalesReturn Order"
{
    trigger OnRun()
    begin
    ...
    var
        ...
        TargetOrderID: Code[20];
        TargetInvoiceID: Code[20];
        CustomerName: Text;
    ...
    begin
        ...
        If SalesInputDataJsonObject.Contains('inputData') then begin
            ...
            TargetOrderID := i95WebServiceExecuteCU.ProcessJsonTokenasCode('targetOrderId', SalesInputDataJsonObject);
            ...
            TargetInvoiceID := i95WebserviceExecuteCU.ProcessJsonTokenasCode('targetInvoiceId', SalesInputDataJsonObject);
            ...
            If SalesInputDataJsonObject.Contains('customer') then begin
                ...
                CustomerName := i95WebServiceExecuteCU.ProcessJsonTokenasText('name', SOAddressJsonObject);
        ...
        If SalesOrderNo <> '' then begin
            ...
            IF TargetInvoiceID <> '' then begin
                SalesHeader.Validate("External Document No.", TargetInvoiceID);
                // SalesHeader.Validate("Applies-to Doc. Type", SalesHeader."Applies-to Doc. Type"::Invoice);
                // SalesHeader.Validate("Applies-to Doc. No.", TargetInvoiceID);
            end;
            ...
            if SalesInputDataJsonObject.Contains('returnItems') then begin
                SalesInputDataJsonObject.get('returnItems', SalesLineInputDataJsonToken);
            ...
            foreach SalesLineInputDataJsonToken in SalesLineInputDataJsonArray do begin
                ...
                QuantityOrdered := i95WebserviceExecuteCU.ProcessJsonTokenasDecimal('qtyRequested', SalesLineInputDataJsonObject);
                //SpecialPrice := i95WebserviceExecuteCU.ProcessJsonTokenasDecimal('specialPrice', SalesLineInputDataJsonObject);
                ReturnReason := i95WebServiceExecuteCU.ProcessJsonTokenasText('reason', SalesLineInputDataJsonObject);
    ...
    begin
        ...
        SalesLine.init();
        SalesLine.Validate("Document Type", SalesLine."Document Type"::"Return Order");
        ...
        SalesLine."Return Reason Code" := ReturnReason;
